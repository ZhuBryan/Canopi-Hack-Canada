...
create table public.user_preferences (
  ...
  w_schools int default 50 check (w_schools between 0 and 100),
  w_groceries int default 50 check (w_groceries between 0 and 100),
  w_restaurants int default 50 check (w_restaurants between 0 and 100),
  w_cafes int default 50 check (w_cafes between 0 and 100),
  w_parks int default 50 check (w_parks between 0 and 100),
  w_pharmacies int default 50 check (w_pharmacies between 0 and 100),
  w_transit int default 50 check (w_transit between 0 and 100),
